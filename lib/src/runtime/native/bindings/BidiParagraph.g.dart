...
final class BidiParagraph implements ffi.Finalizable {
  ...
  int get level {
    final result = _icu4x_BidiParagraph_level_mv1(_ffi);
    return result;
  }
  ...
  int reorderedLevelAt(int pos) {
    final result = _icu4x_BidiParagraph_reordered_level_at_mv1(_ffi, pos);
    return result;
  }
...
@_DiplomatFfiUse('icu4x_BidiParagraph_level_mv1')
@ffi.Native<ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_BidiParagraph_level_mv1')
// ignore: non_constant_identifier_names
external int _icu4x_BidiParagraph_level_mv1(ffi.Pointer<ffi.Opaque> self);

@_DiplomatFfiUse('icu4x_BidiParagraph_reordered_level_at_mv1')
@ffi.Native<ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>, ffi.Size)>(isLeaf: true, symbol: 'icu4x_BidiParagraph_reordered_level_at_mv1')
// ignore: non_constant_identifier_names
external int _icu4x_BidiParagraph_reordered_level_at_mv1(ffi.Pointer<ffi.Opaque> self, int pos);
