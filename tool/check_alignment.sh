...
#
# icu_kit's vendored icu4x carries a patch adding the 16 KB link flag
# (patch branch: "align Android cdylib to 16 KB pages") — this gate is
# what proves the flag survived a rebase.
#
...
# Highest-versioned subdirectory of $1 (dotted-numeric names, e.g. NDK dirs).
