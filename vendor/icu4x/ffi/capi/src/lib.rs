...
pub mod unstable {
    ...
    // ── icu_kit patch ── experimental facades not exposed by upstream capi
    #[cfg(all(feature = "decimal", feature = "experimental"))]
    pub mod compact_decimal_formatter;
    #[cfg(feature = "experimental")]
    pub mod currency_formatter;
    #[cfg(feature = "experimental")]
    pub mod idna_processor;
    #[cfg(feature = "experimental")]
    pub mod percent_formatter;
    #[cfg(feature = "experimental")]
    pub mod relative_time_formatter;
    #[cfg(feature = "experimental")]
    pub mod units_formatter;
    // formatToParts (ECMA-402 typed part output) — used by decimal AND the
    // experimental formatters, so gated on either being present.
    #[cfg(any(feature = "decimal", feature = "experimental"))]
    pub mod formatted_parts;
    // ── end icu_kit patch ──
    #[cfg(feature = "decimal")]
    pub mod decimal;
    #[cfg(feature = "experimental")]
