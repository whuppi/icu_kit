...
export class BidiParagraph {
    ...
    get level() {
        ...
        const result = wasm.icu4x_BidiParagraph_level_mv1(this.ffiValue);
     ...
     */
    reorderedLevelAt(pos) {

        const result = wasm.icu4x_BidiParagraph_reordered_level_at_mv1(this.ffiValue, pos);
